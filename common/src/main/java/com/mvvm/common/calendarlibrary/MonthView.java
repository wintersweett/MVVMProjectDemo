...
import com.mvvm.common.calendarlibrary.utils.Lunar;
import com.mvvm.common.calendarlibrary.utils.Solar;
import com.mvvm.common.calendarlibrary.utils.Utils;
import com.mvvm.common.utils.DisplayMetricsUtils;
...
public class MonthView extends View {
    ...
    public MonthView(Context context, AttributeSet attrs, int defStyleAttr) {
       ...
       // textSize = (int) ATTRS.get(TEXT_SIZE); //
         textSize = DisplayMetricsUtils.dip2px(getContext(),18); //应产品要求改成这个大小
    ...
    private void covertAndSaveFestival() {
        ...
        for (int day = 1; day <= dayOfMonth; day++) {
            solar.solarDay = day;
            Lunar lunar = com.mvvm.common.calendarlibrary.utils.LunarSolarConverter.SolarToLunar(solar);
