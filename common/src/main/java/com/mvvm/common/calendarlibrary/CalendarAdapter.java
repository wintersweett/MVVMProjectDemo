...
import static com.mvvm.common.calendarlibrary.MonthView.ATTRS;
import static com.mvvm.common.calendarlibrary.MonthView.DEFAULT_DIS_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.DEFAULT_SAME_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.DEFAULT_SELECT_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.DEFAULT_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.DEFAULT_TOP_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.DEFAULT_WEEKEND_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.DIS_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.DIVIDER_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.DIVIDER_HEIGHT;
import static com.mvvm.common.calendarlibrary.MonthView.FIRST_SELECT_DAY_TEXT;
import static com.mvvm.common.calendarlibrary.MonthView.FIRST_TOP_MARGIN;
import static com.mvvm.common.calendarlibrary.MonthView.LAST_SELECT_DAY_TEXT;
import static com.mvvm.common.calendarlibrary.MonthView.MAX_DATE;
import static com.mvvm.common.calendarlibrary.MonthView.MIN_DATE;
import static com.mvvm.common.calendarlibrary.MonthView.MONTH_PADDING_BOTTOM;
import static com.mvvm.common.calendarlibrary.MonthView.MONTH_PADDING_LEFT;
import static com.mvvm.common.calendarlibrary.MonthView.MONTH_PADDING_RIGHT;
import static com.mvvm.common.calendarlibrary.MonthView.MONTH_PADDING_TOP;
import static com.mvvm.common.calendarlibrary.MonthView.ROW_HEIGHT;
import static com.mvvm.common.calendarlibrary.MonthView.SAME_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.SECOND_TOP_MARGIN;
import static com.mvvm.common.calendarlibrary.MonthView.SELECTION_MODE;
import static com.mvvm.common.calendarlibrary.MonthView.SELECT_BG_DRAWABLE;
import static com.mvvm.common.calendarlibrary.MonthView.SELECT_MAX_RANGE;
import static com.mvvm.common.calendarlibrary.MonthView.SELECT_RANGE_BG_DRAWABLE;
import static com.mvvm.common.calendarlibrary.MonthView.SELECT_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.TEXT_SIZE;
import static com.mvvm.common.calendarlibrary.MonthView.TEXT_STYLE;
import static com.mvvm.common.calendarlibrary.MonthView.THIRD_TOP_MARGIN;
import static com.mvvm.common.calendarlibrary.MonthView.TOP_SIZE;
import static com.mvvm.common.calendarlibrary.MonthView.TOP_TEXT_COLOR;
import static com.mvvm.common.calendarlibrary.MonthView.WEEKEND_TEXT_COLOR;
...
final class CalendarAdapter extends RecyclerView.Adapter<CalendarAdapter.CalendarHolder> implements
    ...
    private void parseTypedArray(Context context, TypedArray typedArray) {
        ...
        ATTRS.put(MonthView.BOTTOM_TEXT_SIZE, bottomTextSize);
