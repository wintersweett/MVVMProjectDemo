package com.mvvm.base.permission;
...
import com.mvvm.base.permission.helper.PermissionHelper;
...
public class PermissionManager {
    ...
    public static boolean hasPermissions(Activity activity , @NonNull String ... perms){
        UtilsLog.d("ws","getCallPhone:PermissionManager:hasPermission:Activity:"+activity);
        if(activity == null){
